...
class OrderController extends Controller
{
    ...
    public function addProduct(Request $request){
        ...
        } elseif(is_null($brand) and is_null($color) and is_null($size)) {
        ...
        if ($request->getMethod() == 'POST' ){
            ...
            $calc_price = price_calculate($product, $color, $brand, $size, $request['selectedPrice'], count: $count, user: $user);
